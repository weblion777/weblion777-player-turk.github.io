						...
						if( (self.api.video.time > (self.api.video.duration - 10*60)  && imgBannerDisplayed === false && document.getElementsByClassName('fp-eng')[0].style.display === 'none')){ // self.api.video.duration - длительность фильма
							if( startBannerTime == 0 || startBannerTime + 60 > self.api.video.time) // проверка показа баннера в течении минуты
							{
								...
								if(! document.getElementById("banner_before_end1"))
								{
									...
									document.getElementsByClassName('fp-player')[0].insertAdjacentHTML('beforeend','<div id="banner_before_end2" class="img_banner_block" style="position: absolute;top: 20%;left: 50%;transform: translate(-50%, 0%);z-index:9998; top: 25px;max-width: 100%;display:none"><ins class="604c7625" data-key="4568557aa87a9d26a1c3dcbe8478fbe8"></ins></div>');
									...
									document.getElementById('banner_before_end2').appendChild(newScript);
